    ...
    return (
        <PageContent width="95%" maxWidth="1200px" center gutters>
            ...
            <section>
                ...
                <Paragraph>
                    The NHLBI BioData Catalyst Fellows Program provides early-career researchers (graduate students, postdocs, junior faculty, and others)
                    ...
                    The program is open to academic disciplines conducting biomedical research, particularly in heart, lung, blood, and sleep (HLBS) domains,
                    which may or may not include the impact of Coronavirus (COVID-19) in those domains. 
                </Paragraph>
        
                <Paragraph>
                    The vision for the BioData Catalyst is to be a community-driven ecosystem implementing data science solutions, democratizing data and computational access,
                    extending services such as TOPMed and dbGaP, and advancing HLBS science. The BioData Catalyst Fellows Program offers a mechanism for
                    early career researchers to engage with the Consortium as partners in the BioData Catalyst endeavor.
                </Paragraph>
            ...
            <section>
                ...
                <Paragraph>
                    Preference will be given to proposals that leverage the strengths of the ecosystem to enable cutting edge research and also test the capabilities of the ecosystem.
                    Consideration will be given to early-career applicants (graduate students, postdocs, junior faculty, and others), especially those who will bring diversity to the BioData Catalyst community. 
                </Paragraph>
    
                <Paragraph>
                    The Cohort 2 fellowship funding period will run 12 months, from September 2020 to September 2021, with a brief project report due six months into the project (February 2021) and a final report due at the end (September 2021).
                    All Fellows will be expected to be involved in NHLBI BioData Catalyst activities during the year, including attending quarterly consortium meetings and participating in monthly Fellows meetings.
                    Fellows will also be encouraged to make their workflows and tools more widely available within the ecosystem and the broader research community and to welcome and help onboard new users to the community.
                </Paragraph>
            </section>
            ...
            <section>
                ...
                <Paragraph>
                    Awardees will receive a stipend of up to $69,733, which includes costs for salary, travel, training, publication, and conference fees.
                    As part of the Uniform Guidance, fellowships are not subject to indirect costs, and these should not be budgeted.
                    Reasonable cloud costs will be covered by NHLBI and should not be included in your budget. 
                </Paragraph>
            </section>
            ...
            <section>
                ...
                <OrderedList>
                    ...
                    <ListItem
                        ...
                        secondary="Describe concisely the specific research approach you intend to take, specifically outlining aims, goals, deliverables, and timelines for the year. (375 words maximum)"
                    />
                    <ListItem
                    ...
                    <ListItem
                        ...
                        secondary="Explain what methods and material are to be used in the project such as protocols, data, software, analysis; and how you plan to use the BioData Catalyst ecosystem to enhance your proposed project. Provide details on the status of your access to the relevant datasets (e.g. IRB approval, data use agreements), whether you are currently engaged with working groups (e.g. TOPMED), and/or outline plans to obtain data access during the Fellows Program. Include an estimate of the scale of the proposed analyses (e.g., the sample size, number of proposed analyses, and types data expected to be used). (175 words maximum)"
                    />
                    <ListItem
                        primary="Engagement"
                        secondary="Indicate how you plan to share your research, particularly your data and software, and how you will engage and collaborate with Consortium members, Fellows peer group, and the broader community, as an ambassador for BioData Catalyst.  (100 words maximum)"
                    />
                    <ListItem
                        primary="Budget Estimate"
                        secondary="Provide a budget estimate including costs for salary, travel, training, publication, and conference fees. (75 words maximum)"
                    />
                    <ListItem
                        primary="References"
            ...
            <section>
                ...
                <Paragraph>
                    Applicants should expect to be notified of their award status approximately one month after the submission window closes (see the timeline above for anticipated dates).
                    Applicants who receive an award should expect to immediately begin the process of establishing a subcontract award between their home institution and the University of North Carolina at Chapel Hill. 
                </Paragraph>
            </section>
            ...
            <section>
                ...
                <Paragraph>
                    Questions regarding the Fellows Program may be directed to the NHLBI BioData Catalyst Help Desk and
                    by selecting the <strong>Fellows Program</strong> type from the <Link to="/contact">contact form</Link>.
                </Paragraph>
            </section>
