...
const FellowsPage = () => (
    <PageContent width="95%" maxWidth="1200px" center gutters>
        ...
        <section>
            ...
            <OrderedList>
                <ListItem primary="<strong>Profile information</strong> &ndash; Provide your name, organization, department, position title, research area, email address, and your profile web page." />
                <ListItem primary="<strong>Letters of support</strong> &ndash; Two signed letters of support from mentors or key collaborators are required. Letters for projects arising from TOPMed Working Groups should demonstrate the applicant’s participation in a relevant working group and confirm that the applicant has (or will have) access to the appropriate data and that the proposed project is supported by the Working Group. Letters of support should include contact information of the reference (full name, position title, organization, email/phone number, and signature)." />
                <ListItem primary="<strong>Biographical sketch</strong> &ndash; NIH biosketch or a biographical sketch (not to exceed 5 pages) is required." />
                <ListItem primary="<strong>Abstract</strong> &ndash; Provide an abstract on your research question and how your proposed project will address the goals of the Fellows Program. (125 words maximum)" />
                <ListItem primary="<strong>Project aims</strong> &ndash; Describe concisely the specific research approach you intend to take, specifically outlining aims, goals, deliverables, and timelines for the year. (375 words maximum)" />
                <ListItem primary="<strong>Prior studies</strong> &ndash; Using examples of work, by you or others, please outline how your proposed project would align with past studies. Please provide sufficient background to demonstrate project feasibility, and that your project can be completed successfully in the duration of the year. (175 words maximum)" />
                <ListItem primary="<strong>Expertise</strong> &ndash; Describe your familiarity with genomic analysis, statistical programming, and cloud based computation. (125 words maximum)" />
                <ListItem primary="<strong>Methods and materials</strong> &ndash; Explain what methods and material are to be used in the project such as protocols, data, software, analysis; and how you plan to use the BioData Catalyst ecosystem to enhance your proposed project. Provide details on the status of your access to the relevant datasets (e.g. IRB approval, data use agreements), whether you are currently engaged with working groups (e.g. TOPMED), and/or outline plans to obtain data access during the Fellows Program. Include an estimate of the scale of the proposed analyses (e.g., the sample size, number of proposed analyses, and types data expected to be used). (175 words maximum)" />
                <ListItem primary="<strong>Engagement</strong> &ndash; Indicate how you plan to share your research, particularly your data and software, and how you will engage and collaborate with Consortium members, Fellows peer group, and the broader community, as an ambassador for BioData Catalyst.  (100 words maximum)" />
                <ListItem primary="<strong>Budget estimate</strong> &ndash; Provide a budget estimate including costs for salary, travel, training, publication, and conference fees. (75 words maximum)" />
                <ListItem primary="<strong>References</strong> &ndash; Provide a list of references cited in the previous questions here (125 words maximum)" />
            </OrderedList>
