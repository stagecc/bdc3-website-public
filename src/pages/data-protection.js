  ...
  <PageContent width="95%" maxWidth="1200px" center gutters>
    ...
    <section>
      ...
      <Paragraph>
        ...
        <ExternalLink to="https://osp.od.nih.gov/scientific-sharing/genomic-data-sharing/">
    ...
    <section>
      ...
      <Paragraph>
        ...
        <ExternalLink to="https://dbgap.ncbi.nlm.nih.gov">
        ...
        <ExternalLink to="https://oauth.net/">OAuth 2.0</ExternalLink> and{" "}
        <ExternalLink to="https://openid.net/connect/">
          Open ID Connect
        </ExternalLink>{" "}
        (OIDC) services, which are connected to{" "}
        <ExternalLink to="https://era.nih.gov/">
    ...
    <section>
      ...
      <Paragraph>
        ...
        <ExternalLink to="https://grants.nih.gov/grants/guide/notice-files/NOT-OD-19-023.html">
          Summary Results
        </ExternalLink>
