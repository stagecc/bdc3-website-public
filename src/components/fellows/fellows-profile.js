...
export const FellowsProfile = ({ name, institution, bio, projectTitle, projectAbstract, photo }) => {
        ...
        <Wrapper id={ kebabCase(name.replace(/,.+$/, '')) } compact={ isCompact }>
            ...
            <FellowDetails>
                <FellowHeading>
                    ...
                    <FellowOrganization center={ isCompact }>{ institution }</FellowOrganization>
                </FellowHeading>
                <FellowBio dangerouslySetInnerHTML={{ __html: bio }} />
                <Collapser
                    title={ <FellowAbstractTitle>Project: { projectTitle }</FellowAbstractTitle> }
