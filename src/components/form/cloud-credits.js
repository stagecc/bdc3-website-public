...
export const CloudCreditsForm = props => {
  ...
  const [previousFundingDetailsLength, setPreviousFundingDetailsLength] = useState(0)
  ...
  const handleChangeCollaborators = event => setCollaborators(event.target.value)
  ...
  const handleChangePreviousFunding = event => setPreviousFunding(event.target.value)
          ...
          !wasSubmitted && platformOptions.length > 0 && (
            <Form onSubmit={ handleSubmit }>
              ...
              <FormControl>
                ...
                />
                <HelpText>
                  Limit your response to 3000 characters.
                  (Current length: { projectLength } / 3000 characters.)
                </HelpText>
              </FormControl>
              <FormControl>
              ...
              <FormControl>
                ...
                <HelpText>
                  ...
                  (Current length: { previousFundingDetailsLength } / 3000 characters.)
                </HelpText>
              </FormControl>
              <FormControl>
                ...
                <HelpText>
                  Reviewers will be interested in:
                    ...
                    6.) Estimated costs split out by development, testing, analysis optimization, and the running of the analysis
                      (provide a basis for the estimated costs e.g. prior research results with reference numbers);
                    7.) Number of samples, cost per sample, and whether there is sufficient power of analysis.
